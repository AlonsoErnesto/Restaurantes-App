...
export default function AddRestaurantForm(props){
    ...
    const [checked, setChecked] = useState('Gourmet');
    ...
    const [restaurantTelefono, setRestaurantTelefono] = useState("")
        ...
        {   
            ...
            uploadImageStorage().then((response)=>{
                ...
                .add({
                    ...
                    // El id del usuario quien creo este restaurante
                ...
                .catch((err)=>{
                    setIsLoading(false);
                    console.log(err);
                    toastRef.current.show("Error al crear el restaurante, intentelo mas tarde.")
                })
            });
    ...
    return(
        <View style={styles.viewForm}>
           ...
           <View style={{flexDirection:'row'}}>
            ...
            <RadioButton.Group  onValueChange={newchecked => setChecked(newchecked)} value={checked}>
